...
output_file = 'for_slurm_two_helices_3cycles.txt'


with open(output_file, 'w') as f:
    for i in range(n):
        
        line = f"""/home/nbizjak/projects/11_04_2023_rigid_connections/.venv/bin/python /home/nbizjak/prosculpt_dev/prosculpt/rfdiff_mpnn_af2_disontiuous.py --original_pdb_path "/home/nbizjak/prosculpt_dev/prosculpt/examples/inputs_for_rfdiff/two_helices.pdb" --output_dir  /home/nbizjak/prosculpt_dev/prosculpt/examples/two_helices_3cycles_model4/outputs/{i:02d} --contig '['A1-37/30-60/A42-70']' --num_designs_rfdiff 2  --num_seq_per_target_mpnn 2 --chains_to_design_mpnn 'A' --af2_mpnn_cycles 3 --af2_models "4" """
        print(line, file=f)
