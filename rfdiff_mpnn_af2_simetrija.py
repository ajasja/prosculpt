...
parser.add_argument("--symmetry", default= symmetry, help="Define the type of symmetry = number of peptides in the symmetrical complex") #could be infered from pdb
...
os.system(f"{python_path_rfdiff} /home/tsatler/RFdif/RFdiffusion/scripts/run_inference.py \
          ...
          inference.symmetry= {args.symmetry}\
